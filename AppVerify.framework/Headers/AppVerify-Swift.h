...
///
- (void)finalizeWithVerificationURL:(NSURL * _Nonnull)verificationURL;
/// Finalize the verification process
/// Use the delegate to check if the verification failed or succeded
...
- (void)viewDidLoad;
- (void)verifyBtnClickedWithPhoneNumber:(NSString * _Nonnull)phoneNumber;
- (void)manualSMSEnteredWithCode:(NSString * _Nonnull)withCode;
- (void)finalizeWithUrl:(NSURL * _Nonnull)url;
- (void)InitiateSuccededWithTTL:(NSTimeInterval)withTTL;
